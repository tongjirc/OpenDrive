...
namespace VehStatus.RSI
{
    ...
    /// </summary>
    [System.Serializable]
    public partial class PathPointList : System.Collections.Generic.List<DefPositionOffset.PositionOffsetLLV>
    {
        /// <summary>
        ...
        /// </summary>
        public PathPointList(System.Collections.Generic.IEnumerable<DefPositionOffset.PositionOffsetLLV> collection) : base(collection) {}
        /// <summary>
            ...
            try {
                for (int i1 = 0; i1 < this.Count; i1++)
                {
                    try {
                        ...
                        Oss.Asn1.Asn1Exception.AppendContext(ex, System.String.Format("[{0}]", i1), "DefPositionOffset.PositionOffsetLLV", "#" + i1.ToString(), "PositionOffsetLLV", false); throw;
                    }
                }
                if (this.Count < 2)
            ...
            try {
                ...
                for (i0 = 0; i0 < this.Count; i0++)
                {
                    try {
                        ...
                        Oss.Asn1.Asn1Exception.AppendContext(ex, System.String.Format("[{0}]", i0), "DefPositionOffset.PositionOffsetLLV", "#" + i0.ToString(), "PositionOffsetLLV", false); throw;
                    }
                }
            } catch (System.Exception ex) {
                Oss.Asn1.Asn1Exception.AppendContext(ex, "", "PathPointList", null, "PathPointList", false); throw;
                ...
                while (true)
                {
                    ...
                    for (i0 = 0; i0 < fragcount0; i0++)
                    {
                        try {
                            ...
                            Oss.Asn1.Asn1Exception.AppendContext(ex, System.String.Format("[{0}]", this.Count), "DefPositionOffset.PositionOffsetLLV", "#" + this.Count.ToString(), "PositionOffsetLLV", false); throw;
                        }
                    }
                    if (fraglast0 < 0)
                        break;
